...
<!--  <a href="https://www.india.gov.in/"> <img src="https://www.hranker.com/blog/wp-content/uploads/2021/03/government-of-india.jpg" style="height:65px; width:80px;margin-right:20px;"></a>-->
      ...
      <a style="text-align: center;"><h4 style="color: black;"><b>CALIBRATION LABORATORY INFORMATION</b></h4></a>
...
<div class="container" style="margin-top:-3px;width:1000px; ">
 ...
 <h3 style="color:green;"><center><%=ServletUtility.getSuccessMessage(request)%></center></h3>
  ...
  <form class="row g-2 needs-validation" action="<%=JWAView.DCC4CTL%>" method="post"style="padding:2px;">
  
  
   
<div  class="alert alert-info">
    <div class="container-fluid">
   <h4 style="color: black;text-align: center">Calibration Laboratory Information</h4>
   <h4 style="text-align: center;color:Black;">Contact Details</h4>
   </div>
    <div  class="row">
   <div class="col-md-6">
    <label for="validationCustom05" class="form-label">Laboratory Name<span style="color:red">*</span></label>
     <input type="text"    class="form-control" id="validationCustom03" th:field="*{calibrationlaboratoryname}" th:classappend="${#fields.hasErrors('calibrationlaboratoryname')}?'is-invalid':''" name="calibrationlaboratoryname">
   <div th:each="e:${#fields.errors('calibrationlaboratoryname')}" th:text="${e}" id="ValidationServer03Feedback" class="invalid-feedback"></div>
  ...
  <div th:each="e:${#fields.errors('phonenumber')}" th:text="${e}" id="ValidationServer03Feedback" class="invalid-feedback"></div>
   ...
   <div class="col-md-6">
    <label for="validationCustom01" class="form-label">Fax<span style="color:red">*</span></label>
  ...
  <div th:each="e:${#fields.errors('fax')}" th:text="${e}" id="ValidationServer03Feedback" class="invalid-feedback"></div>
   ...
   <div class="alert alert-info">
    <div class="container-fluid">
   <h4 style="text-align: center;color: black;">Location Information</h4>
   </div>
 
  <div class="row">
  <div class="col-md-4">
    <label for="validationCustom02" class="form-label">Country<span style="color:red">*</span></label>
    <select class="form-select" aria-label="Default select example" id="country" name="country" th:field="*{country}" th:classappend="${#fields.hasErrors('country')}?'is-invalid':''"onchange="populateStates();">
  ...
  <div class="col-md-4">
    ...
    <input type="text"   class="form-control"  id="validationCustom03" th:field="*{postcode}" th:classappend="${#fields.hasErrors('postcode')}?'is-invalid':''" name="postcode">
  <div th:each="e:${#fields.errors('postcode')}" th:text="${e}" id="ValidationServer03Feedback" class="invalid-feedback"></div>
  </div>
 
   <div class="col-md-12">
    <label for="validationCustom03" class="form-label">Street<span style="color:red">*</span></label>
    <input type="text"  class="form-control"  id="contactno" th:field="*{street}" th:classappend="${#fields.hasErrors('street')}?'is-invalid':''"name="street" >
    <div th:each="e:${#fields.errors('street')}" th:text="${e}" id="ValidationServer03Feedback" class="invalid-feedback"></div>
   </div>
 </div>
 <br>
<div class="col-12" style="text-align: center;">
   <button class="btn btn-primary" name="myButton" type="button" style="justify-content: flex-end;" value="Register" id="submit" onclick="window.location.href='<%=JWAView.DCC3CTL%>'">Previous</button>
   <button class="btn btn-warning" name="myButton" type="submit"  value="Register" id="submit">Save</button>  
   
   <button class="btn btn-success" name="myButton" type="button" style="justify-content: flex-end;" value="Register" id="submit" onclick="window.location.href='<%=JWAView.DCC5CTL%>'">Next</button>
